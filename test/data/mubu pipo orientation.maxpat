...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1455.0, 441.0, 59.0, 22.0 ],
					"text" : "record $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1399.0, 471.0, 210.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 1223.0, 875.0, 73.0, 22.0 ],
					"text" : "pipo.catalog"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 708.0, 569.0, 55.0, 22.0 ],
					"text" : "zl slice 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1025.0, 13.0, 74.0, 24.0 ],
					"text" : "play data"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 968.0, 59.0, 57.0, 21.0 ],
					"text" : "play $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 970.75, 6.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 968.0, 89.0, 188.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 978.0, 533.0, 62.5, 22.0 ],
					"text" : "zl.slice 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "float", "" ],
					"patching_rect" : [ 978.0, 425.0, 715.0, 44.0 ],
...
, 			{
				"box" : 				{
					...
					"cursor_visible" : 1,
					"dirtypatcher" : 1,
					"domain_bounds" : [ -243.307010706385654, 4656.891826754801514 ],
					...
					"useplaceholders" : 1,
					"verbose" : 1,
					"viewconfig" : [ "interface multiwave, fgcolor 255 0 0 1, visible 0, autobounds 1, colormode fgcolor", "interface multiwave, visible 0, autobounds 1, colormode fgcolor", "interface multiwave, fgcolor 255 0 0 1, visible 0, autobounds 1, colormode fgcolor, progress 1, selectioncolor 173 216 230 0.2", "interface multiwave, fgcolor 255 0 0 1, autobounds 1, colormode fgcolor, progress 1, selectioncolor 173 216 230 0.2, visibleindices 0 1 2 3 4 5", "interface multiwave, colormode fgcolor, foremost 4, visibleindices 0 1 2 3 4 5" ],
					"windresize" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1364.0, 433.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 1152.5, 228.0, 1006.0, 228.0, 1006.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 987.5, 573.5, 988.5, 573.5 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1153.5, 351.0, 1006.0, 351.0, 1006.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1153.5, 321.0, 1006.0, 321.0, 1006.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1152.5, 162.0, 1006.0, 162.0, 1006.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1153.5, 291.0, 1006.0, 291.0, 1006.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1152.5, 192.0, 1006.0, 192.0, 1006.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 1,
					"midpoints" : [ 1153.5, 411.0, 997.0, 411.0, 997.0, 420.0, 987.5, 420.0 ],
					"order" : 0,
					"source" : [ "obj-44", 0 ]
				}
